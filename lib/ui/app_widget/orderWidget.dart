...
class CreateBtnWidget extends StatefulWidget {
  const CreateBtnWidget({Key? key}) : super(key: key);

  @override
  State<CreateBtnWidget> createState() => _CreateBtnWidgetState();
}

class _CreateBtnWidgetState extends State<CreateBtnWidget> {
  @override
  Widget build(BuildContext context) {
    final appBloc = BlocProvider.of<AppBloc>(context);
    void _createEvent() {
