...
class SummaryAndBtnWidget extends StatelessWidget {
  const SummaryAndBtnWidget({Key? key}) : super(key: key);
        ...
        children: [
          Row(
            ...
            children: [
              ...
              IconButton(icon: Icon(Icons.countertops), onPressed: _inc,),
              // _countBuilder(data: data),
              _countBuilder(data,state),

              IconButton(icon: Icon(Icons.plus_one), onPressed: _decr,),
